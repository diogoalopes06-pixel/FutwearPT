      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-16 grid lg:grid-cols-2 gap-10">
          <div className="space-y-8">
            ...
            <a href="https://www.instagram.com/asdeliciasdaquintinha/" target="_blank" rel="noreferrer" className="block bg-brand-espresso text-brand-bone p-6 hover:bg-brand-red transition-colors">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[10px] uppercase tracking-[0.2em] text-brand-bone/70">Acompanhe-nos</p>
                  <p className="mt-1 font-serif text-2xl">Instagram · @asdeliciasdaquintinha</p>
                </div>
            ...
            <a href="https://www.tiktok.com/@asdeliciasdaquintinha" target="_blank" rel="noreferrer" className="block bg-brand-espresso text-brand-bone p-6 hover:bg-brand-red transition-colors">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-[10px] uppercase tracking-[0.2em] text-brand-bone/70">Acompanhe-nos</p>
                  <p className="mt-1 font-serif text-2xl">TikTok · @asdeliciasdaquintinha</p>
                </div>
